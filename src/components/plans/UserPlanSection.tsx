...
const UserPlanSection = () => {
  const plans = [
    ...
    },
    {
      ...
      currency: 'THB',
      icon: '⭐',
      features: ['Up to 10 pets', 'Advanced analytics', 'Vet appointments', 'Photo uploads', 'connect with google calendar'],
      isPopular: true,
      buttonText: 'Upgrade',
    ...
    },
    {
      ...
      currency: 'THB',
      icon: '👑',
      features: ['Unlimited pets', 'Unlock All feature', 'Access Community', 'Pet Matching'],
      isPopular: false,
      buttonText: 'Upgrade',
      buttonVariant: 'default' as const
    }
